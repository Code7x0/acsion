  ...
  variants: [
    {
      ...
      name: 'Liminal',
      stone: 'Labradorite',
      swatch: 'linear-gradient(135deg, #8a8486 0%, #c7d1d0 45%, #2d2834 100%)',
    ...
    },
    {
      ...
      name: 'Solar',
      stone: 'Sunstone',
      swatch: 'linear-gradient(135deg, #312031 0%, #2d2834 45%, #b08a3e 100%)',
    ...
    },
    {
      ...
      name: 'Aether',
      stone: 'Clear Quartz',
      swatch: 'linear-gradient(135deg, #ebe6e1 0%, #c7d1d0 45%, #8a8486 100%)',
    ...
    variants: [
      {
        ...
        name: collection,
        stone: 'Standard',
        swatch: 'linear-gradient(135deg, #8a8486 0%, #c7d1d0 100%)',
        image,
        available: true,
      },
    ],
  ...
  variants: [
    {
      ...
      name: 'Dawnlight',
      stone: 'Dawnlight',
      swatch: 'linear-gradient(135deg, #312031 0%, #4a3a4d 45%, #b08a3e 100%)',
