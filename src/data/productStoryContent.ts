...
export const ascensionCharmStory: ProductStoryContent = {
  ...
  lifestyleImage: '/images/products/ascension-charm/4.jpg',
  lifestyleImageAlt: 'Gold Ascension Charm standing on textured stone with cream fabric and dried flowers',
  showDivider: true,
